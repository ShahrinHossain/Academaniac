        ...
        for row in reader:
            ...
            if second_attribute is not None:
                ...
                if len(gre_scores) > 1:
                    ...
                    gre_sum = int(gre_scores[0][:-1])

                modified_row = [first_attribute, second_attribute, row[2], gre_sum]  # Replace GRE column with average
...
modify_csv(96, "work_files/fields_removed.csv", "work_files/final_gre.csv")
