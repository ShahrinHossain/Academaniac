...
joblib.dump(logreg, 'saved_models/all/logistic_regression_model.joblib')
joblib.dump(scaler, 'saved_models/all/scaler.joblib')
joblib.dump(label_encoder, 'saved_models/all/label_encoder.joblib')
